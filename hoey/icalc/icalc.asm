...
section .data
    ...
    inci        db      "Number 1 is incremented", 0
    deci        db      "Number 1 is decremented", 0
...
main:
    ...
    ; substracting----------------------------------------------------------
    mov     rax, [number1]
    sub     rax, [number2]      ; substract number2 to rax
    mov     [resulti], rax      
    ...
    idiv qword  [number2]        ; multiply rax with number2
    mov         [resulti], rax   ; divide rax by number2, modulo in rdx
